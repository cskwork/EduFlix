...
const COUNTRY_EXPLANATIONS = {"이탈리아": "로마는 이탈리아의 수도입니다. 피자와 파스타는 오늘날 여러 나라에서 즐깁니다.", "프랑스": "에펠탑은 프랑스의 수도 파리에 있습니다.", "호주": "호주와 오스트리아는 서로 다른 나라입니다. 코알라는 호주에 자연적으로 분포합니다.", "대한민국": "서울은 대한민국의 수도입니다.", "미국": "자유의 여신상은 미국 뉴욕항에 있으며 프랑스에서 온 우정의 선물입니다.", "중국": "만리장성은 중국에 있는 여러 시대의 성벽 유적입니다.", "이집트": "기자의 피라미드와 대스핑크스는 이집트에 있습니다. 다른 나라에도 피라미드 형태의 건축물이 있습니다.", "브라질": "브라질리아는 브라질의 수도입니다. 삼바는 브라질의 여러 문화 전통 중 하나입니다.", "캐나다": "캐나다 국기 가운데에는 빨간 단풍잎이 있습니다.", "네덜란드": "네덜란드에는 풍차와 물 관리의 역사가 있습니다. 한 가지 상징이 나라의 모든 문화를 뜻하지는 않습니다."};
...
function generateGameQuizzes() {
  ...
  return shuffled.map(item => {
    ...
    return {
      ...
      exp: COUNTRY_EXPLANATIONS[item.a]
    };
  });
}
